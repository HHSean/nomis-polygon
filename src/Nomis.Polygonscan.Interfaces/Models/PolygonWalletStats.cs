...
namespace Nomis.Polygonscan.Interfaces.Models
{
        ...
        : IWalletStats
    {
        ...
        /// <inheritdoc/>
        [Description("Wallet balance (MATIC)")]
        ...
        /// <inheritdoc/>
        [Description("The movement of funds on the wallet (MATIC)")]
        ...
        /// <inheritdoc/>
        [Description("NFT trading activity (MATIC)")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Description("NFT worth on wallet (MATIC)")]
